...
const string Mlprovenance::IDENTIFIEDPATTERNDELETE = "identifiedPatternDelete";
...
Mlprovenance::DemuxRecv (Ptr<Tuple> tuple)
{
  ...
  if (IsRecvEvent (tuple, IDENTIFIEDPATTERN))
    {
      Prov_r6_1_ecaAdd (tuple);
    }
  if (IsRecvEvent (tuple, IDENTIFIEDPATTERNDELETE))
    {
      Prov_r6_1_ecaDel (tuple);
    }
  ...
  if (IsRecvEvent (tuple, CLIST))
    {
      Prov_r7_1_ecaAdd (tuple);
    }
  if (IsRecvEvent (tuple, CLISTDELETE))
    {
      Prov_r7_1_ecaDel (tuple);
    }
  ...
  if (IsRecvEvent (tuple, ERESULTTEMP))
    {
      Prov_r9_2_ecaAdd (tuple);
    }
  if (IsRecvEvent (tuple, ERESULTTEMPDELETE))
    {
      Prov_r9_2_ecaDel (tuple);
    }
  if (IsRecvEvent (tuple, ERESULTTEMP))
    {
      Prov_r9_3_ecaAdd (tuple);
    }
  if (IsRecvEvent (tuple, ERESULTTEMPDELETE))
    {
      Prov_r9_3_ecaDel (tuple);
    }
  if (IsRecvEvent (tuple, ERESULT))
    {
      Prov_r9_4_ecaAdd (tuple);
    }
  if (IsRecvEvent (tuple, ERESULTDELETE))
    {
      Prov_r9_4_ecaDel (tuple);
    }
  if (IsRecvEvent (tuple, ERESULT))
    {
      Prov_r9_5_ecaAdd (tuple);
    }
  if (IsRecvEvent (tuple, ERESULTDELETE))
    {
      Prov_r9_5_ecaDel (tuple);
    }
  if (IsInsertEvent (tuple, ASSOCIATIONRULE))
    {
...
void
Mlprovenance::Prov_r1_2_ecaAdd (Ptr<Tuple> epListTemp)
{
...
void
Mlprovenance::Prov_r1_2_ecaDel (Ptr<Tuple> epListTempDelete)
{
...
void
Mlprovenance::Prov_r1_3_ecaAdd (Ptr<Tuple> epListTemp)
{
...
void
Mlprovenance::Prov_r1_3_ecaDel (Ptr<Tuple> epListTempDelete)
{
...
void
Mlprovenance::Prov_r1_4_ecaAdd (Ptr<Tuple> epList)
{
...
void
Mlprovenance::Prov_r1_4_ecaDel (Ptr<Tuple> epListDelete)
{
...
void
Mlprovenance::Prov_r1_5_ecaAdd (Ptr<Tuple> epList)
{
...
void
Mlprovenance::Prov_r1_5_ecaDel (Ptr<Tuple> epListDelete)
{
...
void
Mlprovenance::Prov_r2_1_ecaAdd (Ptr<Tuple> pList)
{
...
void
Mlprovenance::Prov_r2_1_ecaDel (Ptr<Tuple> pListDelete)
{
...
void
Mlprovenance::Prov_r2_2_ecaAdd (Ptr<Tuple> epIterateTemp)
{
...
void
Mlprovenance::Prov_r2_2_ecaDel (Ptr<Tuple> epIterateTempDelete)
{
...
void
Mlprovenance::Prov_r2_3_ecaAdd (Ptr<Tuple> epIterateTemp)
{
...
void
Mlprovenance::Prov_r2_3_ecaDel (Ptr<Tuple> epIterateTempDelete)
{
...
void
Mlprovenance::Prov_r2_4_ecaAdd (Ptr<Tuple> epIterate)
{
...
void
Mlprovenance::Prov_r2_4_ecaDel (Ptr<Tuple> epIterateDelete)
{
...
void
Mlprovenance::Prov_r2_5_ecaAdd (Ptr<Tuple> epIterate)
{
...
void
Mlprovenance::Prov_r2_5_ecaDel (Ptr<Tuple> epIterateDelete)
{
...
void
Mlprovenance::Prov_r3_1_ecaAdd (Ptr<Tuple> pIterate)
{
...
void
Mlprovenance::Prov_r3_1_ecaDel (Ptr<Tuple> pIterateDelete)
{
...
Mlprovenance::Prov_r4_1_ecaAdd (Ptr<Tuple> pIterate)
{
  ...
  result->Assign (Assignor::New ("AnotherL",
    FItem::New (
      VarExpr::New ("pIterate_attr4"),
      VarExpr::New ("pIterate_attr3"))));
...
void
Mlprovenance::Prov_r4_2_ecaAdd (Ptr<Tuple> epredictionTemp)
{
...
void
Mlprovenance::Prov_r4_2_ecaDel (Ptr<Tuple> epredictionTempDelete)
{
...
void
Mlprovenance::Prov_r4_3_ecaAdd (Ptr<Tuple> epredictionTemp)
{
...
void
Mlprovenance::Prov_r4_3_ecaDel (Ptr<Tuple> epredictionTempDelete)
{
...
void
Mlprovenance::Prov_r4_4_ecaAdd (Ptr<Tuple> eprediction)
{
...
void
Mlprovenance::Prov_r4_4_ecaDel (Ptr<Tuple> epredictionDelete)
{
...
void
Mlprovenance::Prov_r4_5_ecaAdd (Ptr<Tuple> eprediction)
{
...
void
Mlprovenance::Prov_r4_5_ecaDel (Ptr<Tuple> epredictionDelete)
{
...
void
Mlprovenance::Prov_r6_1_ecaAdd (Ptr<Tuple> identifiedPattern)
{
  RAPIDNET_LOG_INFO ("Prov_r6_1_ecaAdd triggered");
...
void
Mlprovenance::Prov_r6_1_ecaDel (Ptr<Tuple> identifiedPatternDelete)
{
  RAPIDNET_LOG_INFO ("Prov_r6_1_ecaDel triggered");
        ...
        Operation::New (RN_PLUS,
          Operation::New (RN_PLUS,
            Operation::New (RN_PLUS,
              Operation::New (RN_PLUS,
                ValueExpr::New (StrValue::New ("identifiedPattern")),
                VarExpr::New ("identifiedPatternDelete_attr1")),
              VarExpr::New ("identifiedPatternDelete_attr2")),
            VarExpr::New ("identifiedPatternDelete_attr3")),
          VarExpr::New ("identifiedPatternDelete_attr4")),
        VarExpr::New ("identifiedPatternDelete_attr5")))));
...
void
Mlprovenance::Prov_r6_2_ecaAdd (Ptr<Tuple> ecListTemp)
{
...
void
Mlprovenance::Prov_r6_2_ecaDel (Ptr<Tuple> ecListTempDelete)
{
...
void
Mlprovenance::Prov_r6_3_ecaAdd (Ptr<Tuple> ecListTemp)
{
...
void
Mlprovenance::Prov_r6_3_ecaDel (Ptr<Tuple> ecListTempDelete)
{
...
void
Mlprovenance::Prov_r6_4_ecaAdd (Ptr<Tuple> ecList)
{
...
void
Mlprovenance::Prov_r6_4_ecaDel (Ptr<Tuple> ecListDelete)
{
...
void
Mlprovenance::Prov_r6_5_ecaAdd (Ptr<Tuple> ecList)
{
...
void
Mlprovenance::Prov_r6_5_ecaDel (Ptr<Tuple> ecListDelete)
{
...
void
Mlprovenance::Prov_r7_1_ecaAdd (Ptr<Tuple> cList)
{
  RAPIDNET_LOG_INFO ("Prov_r7_1_ecaAdd triggered");
...
void
Mlprovenance::Prov_r7_1_ecaDel (Ptr<Tuple> cListDelete)
{
  RAPIDNET_LOG_INFO ("Prov_r7_1_ecaDel triggered");
...
void
Mlprovenance::Prov_r7_2_ecaAdd (Ptr<Tuple> ecIterateTemp)
{
...
void
Mlprovenance::Prov_r7_2_ecaDel (Ptr<Tuple> ecIterateTempDelete)
{
...
void
Mlprovenance::Prov_r7_3_ecaAdd (Ptr<Tuple> ecIterateTemp)
{
...
void
Mlprovenance::Prov_r7_3_ecaDel (Ptr<Tuple> ecIterateTempDelete)
{
...
void
Mlprovenance::Prov_r7_4_ecaAdd (Ptr<Tuple> ecIterate)
{
...
void
Mlprovenance::Prov_r7_4_ecaDel (Ptr<Tuple> ecIterateDelete)
{
...
void
Mlprovenance::Prov_r7_5_ecaAdd (Ptr<Tuple> ecIterate)
{
...
void
Mlprovenance::Prov_r7_5_ecaDel (Ptr<Tuple> ecIterateDelete)
{
...
void
Mlprovenance::Prov_r8_1_ecaAdd (Ptr<Tuple> cIterate)
{
...
void
Mlprovenance::Prov_r8_1_ecaDel (Ptr<Tuple> cIterateDelete)
{
...
void
Mlprovenance::Prov_r9_2_ecaAdd (Ptr<Tuple> eresultTemp)
{
  RAPIDNET_LOG_INFO ("Prov_r9_2_ecaAdd triggered");
...
void
Mlprovenance::Prov_r9_2_ecaDel (Ptr<Tuple> eresultTempDelete)
{
  RAPIDNET_LOG_INFO ("Prov_r9_2_ecaDel triggered");
...
void
Mlprovenance::Prov_r9_3_ecaAdd (Ptr<Tuple> eresultTemp)
{
  RAPIDNET_LOG_INFO ("Prov_r9_3_ecaAdd triggered");
...
void
Mlprovenance::Prov_r9_3_ecaDel (Ptr<Tuple> eresultTempDelete)
{
  RAPIDNET_LOG_INFO ("Prov_r9_3_ecaDel triggered");
...
void
Mlprovenance::Prov_r9_4_ecaAdd (Ptr<Tuple> eresult)
{
  RAPIDNET_LOG_INFO ("Prov_r9_4_ecaAdd triggered");
...
void
Mlprovenance::Prov_r9_4_ecaDel (Ptr<Tuple> eresultDelete)
{
  RAPIDNET_LOG_INFO ("Prov_r9_4_ecaDel triggered");
...
void
Mlprovenance::Prov_r9_5_ecaAdd (Ptr<Tuple> eresult)
{
  RAPIDNET_LOG_INFO ("Prov_r9_5_ecaAdd triggered");
...
void
Mlprovenance::Prov_r9_5_ecaDel (Ptr<Tuple> eresultDelete)
{
  RAPIDNET_LOG_INFO ("Prov_r9_5_ecaDel triggered");
...
void
Mlprovenance::Prov_edb_2Eca1Ins (Ptr<Tuple> image)
{
...
void
Mlprovenance::Prov_edb_2Eca1Del (Ptr<Tuple> image)
{
